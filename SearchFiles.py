...
START_LOCATION = "C:\\Users\\henkj\\OneDrive\\Fotos\\2009"
...
# STEP 5: Sort the files ascending (False) or descending (True)
SORT_REVERSE = False
#SORT_REVERSE = True


# STEP 6: Define which COLUMNS in the report, in what order
#COLUMNS = ['name', 'path', 'size', 'created', 'modified', 'accessed']
#COLUMNS = ['name', 'path', 'created']
#COLUMNS = ['name', 'exifdate', 'width', 'height']
COLUMNS = ['name', 'exifdate', 'width', 'height', 'path']
